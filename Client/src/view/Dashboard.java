...
import static controller.Client.listMsgContacts;
...
//        jScrollPane2 = new javax.swing.JScrollPane(panelListMsgContacts);
    ...
    private void initComponents() {
        ...
        navMainLayout.setVerticalGroup(
            ...
            .addGroup(navMainLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(scrollNavMsgContacts, javax.swing.GroupLayout.DEFAULT_SIZE, 348, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//                        e.printStackTrace();
    ...
    void handleClickEachMsgContact(String idContact) {
//        #419FD9
//#D5C4B2
//        #E2EFEC
//formal
        Color colorBg = new java.awt.Color(255, 255, 255);
        Color colorNameContact = new java.awt.Color(34, 34, 34);
        Color colorContentMsgContact = new java.awt.Color(102, 102, 102);

//color on click
        Color colorTextClick = new java.awt.Color(224, 239, 245);
        Color colorBgClick = new java.awt.Color(65, 159, 217);

        Component[] listPanelChild = listMsgContactsPanel.getComponents();
        for (Component x : listPanelChild) {
            if (x.getName() == null ? idContact + "" == null : x.getName().equals(idContact + "")) {
                System.out.println(x.getName());
                System.out.println(idContact);
                x.setBackground(colorBgClick);
                x.setForeground(colorTextClick);
            } else {
                x.setBackground(colorBg);
            }
        }
    }

    javax.swing.JPanel generateListMsgContacts() {
        javax.swing.JPanel panelListMsgContacts = new javax.swing.JPanel();
        panelListMsgContacts.setBackground(new java.awt.Color(204, 204, 255));

        int size = 10;
        List<javax.swing.JPanel> listEachMsgContact = new ArrayList<>();
        for (int i = 0; i < size; i++) {
            javax.swing.JPanel eachMessage = new javax.swing.JPanel();
            eachMessage.setName("" + i);
            eachMessage.setBackground(new java.awt.Color(255, 255, 255));
            eachMessage.addMouseListener(new java.awt.event.MouseAdapter() {
                public void mouseClicked(java.awt.event.MouseEvent evt) {
                    handleClickEachMsgContact(eachMessage.getName());
                }
            });
            ...
            javax.swing.JLabel nameContact = new javax.swing.JLabel();
            ...
            nameContact.setText("Mr.A");

            javax.swing.JLabel lastSeenContact = new javax.swing.JLabel();
            ...
            lastSeenContact.setText("22/22/2222");

            javax.swing.JLabel contentMsgContact = new javax.swing.JLabel();
            ...
            contentMsgContact.setText("Content new messagemessagemessagemessagemessagemessage");
            ...
            listEachMsgContact.add(new eachMessage());
        }

        javax.swing.GroupLayout panelListMsgContactsLayout = new javax.swing.GroupLayout(panelListMsgContacts);
        panelListMsgContacts.setLayout(panelListMsgContactsLayout);

        ParallelGroup hori = panelListMsgContactsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING);
        SequentialGroup verti = panelListMsgContactsLayout.createSequentialGroup();

        for (int i = 0; i < size; i++) {
            hori.addComponent(listEachMsgContact.get(i), javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE);
            if (i == size - 1) {
                verti.addComponent(listEachMsgContact.get(i), javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE);
            } else {
                verti.addComponent(listEachMsgContact.get(i), javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED);
        ...
        panelListMsgContactsLayout.setHorizontalGroup(hori);
        panelListMsgContactsLayout.setVerticalGroup(
                panelListMsgContactsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(verti)
        );
        return panelListMsgContacts;
    }
