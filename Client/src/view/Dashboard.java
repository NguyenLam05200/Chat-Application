...
//        System.out.println("height: " + jLabel4.getHeight());
     ...
     */
    private void myInit() {
        listMsgContactsPanel = generateListMsgContacts();
...
//        jLabel4.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/background.jpg")).getImage().getScaledInstance(bodyMain.getWidth(), bodyMain.getHeight(), Image.SCALE_SMOOTH)));
    ...
    private void initComponents() {
        ...
        eachMessage4.setBackground(new java.awt.Color(255, 255, 255));
        ...
        contentMsg1.setForeground(new java.awt.Color(102, 102, 102));
        ...
        contentMsg2.setForeground(new java.awt.Color(102, 102, 102));
...
//                        e.printStackTrace();
    ...
    javax.swing.JPanel generateListMsgContacts() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            listEachMsgContact.add(eachMessage);
        }
